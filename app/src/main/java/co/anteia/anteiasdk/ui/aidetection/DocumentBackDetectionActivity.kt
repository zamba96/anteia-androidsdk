...
class DocumentBackDetectionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.fragment_document_back_detection)
    ...
    private fun sendFrame(croppedImage: Bitmap) {
        ...
        viewModel.sendDocumentBack(croppedImage).observe(this,{
            it?.let { resource ->
