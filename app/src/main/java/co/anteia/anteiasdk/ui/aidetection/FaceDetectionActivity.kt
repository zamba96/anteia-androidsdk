...
class FaceDetectionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.fragment_face_detection)
                ...
                if (mediaImage != null) {
                    ...
                    handler.post {
                        ...
                        if (bitmap != null) {
                            ...
                            Log.e(TAG,"Probs: ${probabilities.get(0).toString()}")
    ...
    private fun sendFrame(croppedImage: Bitmap) {
        ...
        viewModel.sendFace(croppedImage).observe(this,{
            it?.let { resource ->
